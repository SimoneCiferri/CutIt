...
public class CustomerAppointmentsView1 extends Decorator {
    ...
    public CustomerAppointmentsView1(ViewComponent1 view){

        super(view);
        try {
            super.loadXML1(ViewLayout1.CUSTOMERAPPOINTMENTS);
        } catch (IOException e){
