...
public class HairdresserDeleteBookedAppointmentsView2 extends Decorator2 {
    ...
    public HairdresserDeleteBookedAppointmentsView2(ViewComponent2 view){

        super(view);
        try {
            super.loadXML2(ViewLayout2.HAIRDRESSERDELETEBOOKEDAPPOINTMENTS);
        } catch (IOException e){
