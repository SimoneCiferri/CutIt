...
public class CustomerBookAppointmentView2 extends Decorator2 {
    ...
    public CustomerBookAppointmentView2(ViewComponent2 view){

        super(view);
        try {
            super.loadXML2(ViewLayout2.CUSTOMERBOOKAPPOINTMENT);
        } catch (IOException e){
