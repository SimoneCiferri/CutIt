...
public class StartView1 implements ViewComponent1 {
    ...
    public void loadXML1(ViewLayout1 layout) throws IOException, NullPointerException {
        if(!loadedView.containsKey(layout) || layout == ViewLayout1.CUSTOMERBOOKAPPOINTMENT || layout == ViewLayout1.SHOPINFO || layout == ViewLayout1.GMAPS || layout == ViewLayout1.SIGNUP){
