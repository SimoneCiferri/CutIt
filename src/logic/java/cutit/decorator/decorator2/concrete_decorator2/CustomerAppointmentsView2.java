...
public class CustomerAppointmentsView2 extends Decorator2 {
    ...
    public CustomerAppointmentsView2(ViewComponent2 view){

        super(view);
        try {
            super.loadXML2(ViewLayout2.CUSTOMERAPPOINTMENTS);
        } catch (IOException e){
