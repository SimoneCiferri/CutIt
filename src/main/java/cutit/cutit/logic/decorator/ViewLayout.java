...
public enum ViewLayout {
    ...
    FAVSHOP("/cutit/cutit/fxml/clientfavouritescs.fxml"), CUSTOMERAPPOINTMENTS("/cutit/cutit/fxml/clientappointments.fxml"), CUSTOMERPROMOTIONS("/cutit/cutit/fxml/clientpromotions.fxml"),
    ...
    CLIENTPROMOTIONINFO("/cutit/cutit/fxml/clientpromotioninfo.fxml"),GMAPS("/cutit/cutit/fxml/gMaps.fxml");
